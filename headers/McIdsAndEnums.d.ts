...
| 'key.fabricskyboxes.toggle'
| 'key.fabricskyboxes.toggle.debug_hud'
...
type SoundId =
| 'controlify:controlify.ui.focus'
...
//@Custom
type ScreenName =
| 'dev.lambdaurora.spruceui.screen.SpruceHandledScreen'
| 'net.earthcomputer.clientcommands.command.PreviewScreen'
| HandledScreenName
...
| 'BetaCraftScreen'
| 'BindConsumerScreen'
| 'BluetoothWarningScreen'
| 'CancelScreen'
| 'ChangelogScreen'
| 'ChestTrackerScreen'
| 'ClassiCubeLoginScreen'
| 'ClassiCubeMFAScreen'
| 'ClassiCubeServerListScreen'
| 'ClothConfigScreen'
| 'ClothRequiresRestartScreen'
| 'ConfigCorruptedScreen'
| 'ConfigPanelAllHotkeys'
| 'ConfigScreen'
| 'ConfigScreenRenderer'
| 'ConfirmScreenBase'
| 'ContinuityConfigScreen'
| 'ControllerCalibrationScreen'
| 'ControllerCarouselScreen'
| 'ControllerMappingMakerScreen'
| 'CreateGroupScreen'
| 'CreateMemoryBankScreen'
| 'CustomConfigScreen'
| 'DebugLoadFailedGridScreen'
| 'DelegateScreen'
| 'DeletePopupScreen'
| 'DeviceOnboardingScreen'
| 'DhScreen'
| 'DownloadingSDLScreen'
| 'EBEConfigScreen'
| 'EMFConfigScreenDebugLogOptions'
| 'EMFConfigScreenMain'
| 'EMFConfigScreenOptions'
| 'EMFConfigScreenTools'
| 'ETFConfigScreen'
| 'ETFConfigScreenBlinkSettings'
| 'ETFConfigScreenDebugSettings'
| 'ETFConfigScreenEmissiveSettings'
| 'ETFConfigScreenGeneralSettings'
| 'ETFConfigScreenMain'
| 'ETFConfigScreenRandomRestrictSettings'
| 'ETFConfigScreenRandomSettings'
| 'ETFConfigScreenSkinSettings'
| 'ETFConfigScreenSkinTool'
| 'ETFConfigScreenSkinToolOutcome'
| 'ETFConfigScreenSkinToolPixelSelection'
| 'ETFConfigScreenWarnings'
| 'EditMemoryBankScreen'
| 'EditMemoryKeysScreen'
| 'EditorScreen'
| 'EncryptionConfigScreen'
| 'EncryptionWarningScreen'
| 'EnterPasswordScreen'
| 'EventMacrosScreen'
| 'ExportScreen'
| 'FSBInteropConfigScreen'
| 'FeatureMissingErrorScreen'
...
| 'GuiWorldMapSettings'
| 'GuiWorldTpCommand'
| 'GuiXaeroPlusWorldMapSettings'
| 'IncompatibleMinimapWarningScreen'
| 'InstallClothConfigScreen'
| 'IntroductionOnboardingScreen'
| 'JoinGroupScreen'
| 'KeyMacrosScreen'
| 'ListScreenBase'
| 'LoginPopupScreen'
...
| 'MacroScreen'
| 'MainMenu'
| 'MemoryBankManagerScreen'
| 'MicOnboardingScreen'
| 'MicrosoftAuthScreen'
| 'MicrosoftCryptPopupScreen'
| 'MicrosoftPopupScreen'
| 'MidnightConfigOverviewScreen'
| 'MidnightConfigScreen'
| 'MigrationAvailableScreen'
| 'MigrationResultScreen'
| 'MinecraftCredits'
| 'ModConfigOpenerScreen'
| 'ModMenuOptionsScreen'
| 'ModernFixConfigScreen'
| 'ModernFixOptionInfoScreen'
| 'ModsScreen'
| 'MoreCullingClothConfigScreen'
| 'MyOptions'
| 'NoSDLScreen'
| 'NoYACLScreen'
| 'OfflineAuthScreen'
...
| 'OtherMenu'
| 'PaginatedAdvancementScreen'
| 'PerServerVersionScreen'
| 'PreviewScreen'
...
| 'SpeakerOnboardingScreen'
| 'SpruceHandledScreen'
| 'SpruceScreen'
| 'SubmitUnknownControllerScreen'
| 'ToggleMenu'
| 'TriageWarningScreen'
...
| 'UpdateModScreen'
| 'VFPScreen'
| 'VoiceActivationOnboardingScreen'
| 'VoiceChatScreen'
| 'VoiceChatScreenBase'
...
| 'key.categories.inventorycleaner'
| 'key.categories.misc'
| 'key.categories.movement'
| 'key.categories.multiplayer'
| 'key.categories.voicechat'
